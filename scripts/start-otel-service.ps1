...
$otelConfigForJvm = "../infrastructure/monitoring/otel-javaagent-config.yaml"
$jvmArguments = "-javaagent:$agentForJvm -Dotel.config.file=$otelConfigForJvm"
Write-Host "Starting $Service with OpenTelemetry Java Agent"
Write-Host "Java Agent: $agentForJvm"
Write-Host "Agent config: $otelConfigForJvm"
